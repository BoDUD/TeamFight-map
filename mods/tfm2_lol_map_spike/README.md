...
- Do not add `asset/base/setting/map_setting` to this repository package. Q2a proves local installed-copy read takeover for an unmodified equivalent remap, but not safe decode/re-encode or mutation.
