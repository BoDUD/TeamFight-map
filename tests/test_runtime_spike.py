...
SPIKE_WALL = SPIKE_MOD / "aseprite_resources" / "ingame" / "5v5" / "wall_5v5.png"
SPIKE_WALL_FRONT = SPIKE_MOD / "aseprite_resources" / "ingame" / "5v5" / "wall_5v5_front.png"
...
class RuntimeSpikeTests(unittest.TestCase):
    ...
    def test_override_table_only_replaces_default_visual_layers(self) -> None:
        ...
        self.assertEqual(
            "asset/tfm2_lol_map_spike/aseprite_resources/ingame/5v5/wall_5v5",
            overrides["asset/base/aseprite_resources/ingame/5v5/wall_5v5"]["remapping"],
        )
        self.assertEqual(
            "asset/tfm2_lol_map_spike/aseprite_resources/ingame/5v5/wall_5v5_front",
            overrides["asset/base/aseprite_resources/ingame/5v5/wall_5v5_front"]["remapping"],
        )
        self.assertNotIn("asset/base/setting/map_setting", overrides)
        self.assertNotIn("asset/base/aseprite_resources/ingame/5v5/minimap_5v5_bg", overrides)

    def test_background_probe_matches_native_background_size(self) -> None:
        for path in (SPIKE_BG, SPIKE_WALL, SPIKE_WALL_FRONT):
